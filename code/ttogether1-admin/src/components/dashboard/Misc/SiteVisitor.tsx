...
import { countryList1 } from '../../../pages/dashboard/routes/data';
	...
	return (
		<div className="row">
			<div className="col-md-6 col-12">
				<div className="mb-3">
					Lorem ipsum is dummy content Cenas in erat accumsan, hendrerit lorem vel, pulvinar odio. Quisque eu
					conva. hendrerit lorem vel, pulvinar odio. Quisque eu conva.
				</div>
