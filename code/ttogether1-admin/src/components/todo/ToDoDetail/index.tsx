...
import labels from 'pages/todo/data/labels';
import { DatePicker } from '@material-ui/pickers';
import users from 'pages/todo/data/users';
						...
						<div className="row">
							<div className="col-sm-6 col-md-8">
								<div className="d-flex align-items-center">
									<div className="user-name mr-md-4 mr-2" onClick={this.handleUserClick}>
										{user === null ? (
				...
				<div className="chat-main-footer todo-main-footer">
					<div className="d-flex flex-row align-items-center" style={{ maxHeight: 61 }}>
						...
						<div className="chat-sent">
							<IconButton onClick={this.submitComment.bind(this)} aria-label="Send message">
