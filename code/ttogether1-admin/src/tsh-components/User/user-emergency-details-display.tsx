...
export interface IUserEmergencyDetailsDisplayProps {
    userId: string;
    editable?: boolean;
    onSubmit?: () => void;
}
...
const UserEmergencyDetailsDisplay: React.FC<IUserEmergencyDetailsDisplayProps> = props => {
                ...
                <>
                    ...
                    <List disablePadding dense className={classes.list}>
                        <ListItem disableGutters>
                            <strong>Local Emergency Phone Number:</strong>
                            <Box pl={1}>
                                {userToDisplay.localEmergencyPhone}
                            </Box>
                        </ListItem>
                        <ListItem disableGutters>
                            <strong>Primary Emergency Phone Number:</strong>
                            <Box pl={1}>
                                {userToDisplay.primaryEmergencyPhone}
                            </Box>
                        </ListItem>
                        {userToDisplay.secondaryEmergencyPhone && (
                            <ListItem disableGutters>
                                <strong>
...
export default UserEmergencyDetailsDisplay;
