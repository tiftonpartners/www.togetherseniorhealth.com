...
import { changeDirection, setDarkTheme, setThemeColor } from '../../store/settings/actions';
...
const ColorOption = (props) => {
	...
	const { themeColor, darkTheme, isDirectionRTL } = useSelector<RootState, SettingsState>(({ settings }) => settings);
					...
					<div className="color-theme-body">
						...
						<div className="row text-left">
							...
							<div className="col-6">
								...
								<Switch color="primary" checked={darkTheme} onChange={handleDarkTheme} />
							</div>
						</div>
						<div className="mt-3">
							<SideNavOption />
