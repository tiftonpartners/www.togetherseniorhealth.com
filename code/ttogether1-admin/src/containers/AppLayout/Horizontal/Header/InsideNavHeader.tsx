...
const InsideNavHeader = () => {
	const { locale } = useSelector<RootState, SettingsState>(({ settings }) => settings);
			...
			<Toolbar className="app-toolbar" disableGutters={false}>
				...
				<Link href="/">
					<a className="app-logo mr-2 d-none d-sm-block">
						<img src="public/images/logo.png" alt="Jambo" title="Jambo" />
					</a>
				</Link>
				...
				<ul className="header-notifications list-inline ml-auto">
					...
					<li className="list-inline-item user-nav">
						<Dropdown className="quick-menu" isOpen={userInfo} toggle={onUserInfoSelect}>
							<DropdownToggle className="d-inline-block" tag="span" data-toggle="dropdown">
...
export default InsideNavHeader;
