...
const ProspectsPage: NextPage = () => {
    const router = useRouter();

    const { type, fromDate, toDate, tz } = router.query;

    return (
        <RequirePermissions perms={['query:prospect']}>
...
export default withAuthenticationRequired(ProspectsPage);
